...
edited.intersection.of.TargetScan.and.miRanda.intersection.compared.with.original.annotated.dt <- fread("./report.ver2/210215-sixth-dataset/201221-fifth-phenotype-collection/all.normal.samples/RE.miRNA.intersection/edited.intersection.of.TargetScan.and.miRanda.compared.with.original.annotated.dt.gz")
...
{
    copy(edited.intersection.of.TargetScan.and.miRanda.intersection.compared.with.original.annotated.dt) -> .;
...

{
    ...
    ggsave.A4(
        filename=glue("{output.directory}/3UTR.types.piechart.png"),
