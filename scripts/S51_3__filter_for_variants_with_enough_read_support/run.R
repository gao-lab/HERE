...
merged.long.disjoint.with.population.without.potential.polymorphism.with.enough.read.support.dt <- merged.long.disjoint.with.population.without.potential.polymorphism.dt[(SUBSET=="Alu" & AN>=10 & AF>=0.1) | (SUBSET!="Alu" & AN>=10 & AF>=0.1 & AC>=3)]
