...
phenotype.output.at.gsm.level.dt <- fread("external/NCBI.SRA.MetaData/GSE144296.txt")[LibrarySource == 'TRANSCRIPTOMIC' & Cell_Line == 'A375', list(gsm=`Sample Name`, gse="GSE144296", is.normal=TRUE, stage="A375")] %>% unique
