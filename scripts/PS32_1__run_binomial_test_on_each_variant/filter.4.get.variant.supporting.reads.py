...
for temp_line in sys.stdin:
    ...
    for temp_index, (temp_base, temp_read_name) in enumerate(zip(temp_fields_list[4], temp_fields_list[6].split(",")), start=1):
