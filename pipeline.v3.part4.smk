...
rule S71_1__combine_multiple_population_isec_results_for_control:
    input:
        isec_UWashington_EVS_vcf_gz_filename="result/S19_1__combine_annotations/{DATASET_COLLECTION_NAME}/__merged__/DNTRSeq-RNA-trimming/hg38.fa/32/bwa-index-10.1038_nmeth.2330/bwa-aln-samsepe/none/GATK-3.6.0/none/151/common_all/complex_filter_1/none/bcftools.isec.with.outer.vcf/basic/1000000000/UWashington.EVS/collapse_all_and_keep_self_vcf/combined.merged.variant.only.bcftools.isec.outer.vcf.result.self.vcf.gz",
        isec_NCBI_ALFA_vcf_gz_filename="result/S19_1__combine_annotations/{DATASET_COLLECTION_NAME}/__merged__/DNTRSeq-RNA-trimming/hg38.fa/32/bwa-index-10.1038_nmeth.2330/bwa-aln-samsepe/none/GATK-3.6.0/none/151/common_all/complex_filter_1/none/bcftools.isec.with.outer.vcf/basic/1000000000/NCBI.ALFA.2020.03.04/collapse_all_and_keep_self_vcf/combined.merged.variant.only.bcftools.isec.outer.vcf.result.self.vcf.gz",
        isec_1000Genomes_vcf_gz_filename="result/S19_1__combine_annotations/{DATASET_COLLECTION_NAME}/__merged__/DNTRSeq-RNA-trimming/hg38.fa/32/bwa-index-10.1038_nmeth.2330/bwa-aln-samsepe/none/GATK-3.6.0/none/151/common_all/complex_filter_1/none/bcftools.isec.with.outer.vcf/basic_without_Y/1000000000/1000Genomes.phased.genotype/collapse_all_and_keep_self_vcf/combined.merged.variant.only.bcftools.isec.outer.vcf.result.self.vcf.gz",
        isec_gnomAD_v211_exomes_vcf_gz_filename="result/S19_1__combine_annotations/{DATASET_COLLECTION_NAME}/__merged__/DNTRSeq-RNA-trimming/hg38.fa/32/bwa-index-10.1038_nmeth.2330/bwa-aln-samsepe/none/GATK-3.6.0/none/151/common_all/complex_filter_1/none/bcftools.isec.with.outer.vcf/basic/1000000000/gnomAD_v2.1.1_exomes/collapse_all_and_keep_self_vcf/combined.merged.variant.only.bcftools.isec.outer.vcf.result.self.vcf.gz",
        isec_gnomAD_v211_genomes_vcf_gz_filename="result/S19_1__combine_annotations/{DATASET_COLLECTION_NAME}/__merged__/DNTRSeq-RNA-trimming/hg38.fa/32/bwa-index-10.1038_nmeth.2330/bwa-aln-samsepe/none/GATK-3.6.0/none/151/common_all/complex_filter_1/none/bcftools.isec.with.outer.vcf/basic_without_Y/1000000000/gnomAD_v2.1.1_genomes/collapse_all_and_keep_self_vcf/combined.merged.variant.only.bcftools.isec.outer.vcf.result.self.vcf.gz",
        isec_gnomAD_v30_genomes_vcf_gz_filename="result/S19_1__combine_annotations/{DATASET_COLLECTION_NAME}/__merged__/DNTRSeq-RNA-trimming/hg38.fa/32/bwa-index-10.1038_nmeth.2330/bwa-aln-samsepe/none/GATK-3.6.0/none/151/common_all/complex_filter_1/none/bcftools.isec.with.outer.vcf/basic/1000000000/gnomAD_v3.0_genomes/collapse_all_and_keep_self_vcf/combined.merged.variant.only.bcftools.isec.outer.vcf.result.self.vcf.gz",
    output:
        flag_S71_1=touch("result/S71_1__combine_multiple_population_isec_results_for_control/{DATASET_COLLECTION_NAME}/finished"),
        isec_all_populations_concatenated_vcf_gz_filename="result/S71_1__combine_multiple_population_isec_results_for_control/{DATASET_COLLECTION_NAME}/isec.all.populations.concatenated.vcf.gz"
    threads:
...
rule S71_2__filter_against_population_variants_for_control:
    input:
        merged_variant_only_vcf_gz_filename="result/S16_1__concatenate_RNA_editing_site_from_a_dataset_collection/{DATASET_COLLECTION_NAME}/__merged__/DNTRSeq-RNA-trimming/hg38.fa/32/bwa-index-10.1038_nmeth.2330/bwa-aln-samsepe/none/GATK-3.6.0/none/151/common_all/complex_filter_1/none/merged.variant.only.vcf.gz",
        isec_all_populations_concatenated_vcf_gz_filename="result/S71_1__combine_multiple_population_isec_results_for_control/{DATASET_COLLECTION_NAME}/isec.all.populations.concatenated.vcf.gz"
    output:
        flag_S71_2=touch("result/S71_2__filter_against_population_variants_for_control/{DATASET_COLLECTION_NAME}/finished"),
        merged_variant_only_disjoint_with_population_variants_vcf_gz_filename=touch("result/S71_2__filter_against_population_variants_for_control/{DATASET_COLLECTION_NAME}/merged.variant.only.disjoint.with.population.variants.vcf.gz")
    params:
        temp_result_directory="result/S71_2__filter_against_population_variants_for_control/{DATASET_COLLECTION_NAME}/temp_result"
    threads:
...
rule S71_3__filter_for_variants_with_enough_read_support_for_control:
    input:
        flag_S71_2="result/S71_2__filter_against_population_variants_for_control/{DATASET_COLLECTION_NAME}/finished",
        merged_variant_only_disjoint_with_population_variants_vcf_gz_filename="result/S71_2__filter_against_population_variants_for_control/{DATASET_COLLECTION_NAME}/merged.variant.only.disjoint.with.population.variants.vcf.gz",
        merged_long_table_dt_txt_gz_filename="result/S16_3__get_RNA_editing_site_long_table_from_a_dataset_collection/{DATASET_COLLECTION_NAME}/__merged__/DNTRSeq-RNA-trimming/hg38.fa/32/bwa-index-10.1038_nmeth.2330/bwa-aln-samsepe/none/GATK-3.6.0/none/151/common_all/complex_filter_1/none/merged.long.table.dt.txt.gz",
        combined_merged_variant_only_snpEff_event_summary_dt_gz_filename="result/S18_1__combine_annotations/{DATASET_COLLECTION_NAME}/__merged__/DNTRSeq-RNA-trimming/hg38.fa/32/bwa-index-10.1038_nmeth.2330/bwa-aln-samsepe/none/GATK-3.6.0/none/151/common_all/complex_filter_1/none/snpEff/basic/10000000/combined.merged.variant.only.snpEff.event.summary.dt.txt.gz"
    output:
        flag_S71_3=touch("result/S71_3__filter_for_variants_with_enough_read_support_for_control/{DATASET_COLLECTION_NAME}/finished"),
        merged_long_disjoint_with_population_dt_txt_gz_filename="result/S71_3__filter_for_variants_with_enough_read_support_for_control/{DATASET_COLLECTION_NAME}/merged.long.disjoint.with.population.dt.txt.gz",
        merged_long_disjoint_with_population_without_potential_polymorphism_dt_txt_gz_filename="result/S71_3__filter_for_variants_with_enough_read_support_for_control/{DATASET_COLLECTION_NAME}/merged.long.disjoint.with.population.without.potential.polymorphism.dt.txt.gz",
        merged_long_disjoint_with_population_without_potential_polymorphism_with_enough_read_support_dt_txt_gz_filename="result/S71_3__filter_for_variants_with_enough_read_support_for_control/{DATASET_COLLECTION_NAME}/merged.long.disjoint.with.population.without.potential.polymorphism.with.enough.read.support.dt.txt.gz"
    threads:
        config['threads_filter_for_variants_with_enough_read_support']
    script:
        "./scripts/S71_3__filter_for_variants_with_enough_read_support_for_control/run.R"




rule S71_4__filter_for_variants_with_enough_sample_support_for_control:
    input:
        flag_S71_3="result/S71_3__filter_for_variants_with_enough_read_support_for_control/{DATASET_COLLECTION_NAME}/finished",
        merged_long_disjoint_with_population_without_potential_polymorphism_with_enough_read_support_dt_txt_gz_filename="result/S71_3__filter_for_variants_with_enough_read_support_for_control/{DATASET_COLLECTION_NAME}/merged.long.disjoint.with.population.without.potential.polymorphism.with.enough.read.support.dt.txt.gz"
    output:
        flag_S71_4=touch("result/S71_4__filter_for_variants_with_enough_sample_support_for_control/{DATASET_COLLECTION_NAME}/{DATASET_PHENOTYPE_COLLECTION_NAME}/finished"),
        merged_long_disjoint_with_population_without_potential_polymorphism_with_enough_read_support_with_phenotype_sequenced_samples_only_dt_txt_gz_filename="result/S71_4__filter_for_variants_with_enough_sample_support_for_control/{DATASET_COLLECTION_NAME}/{DATASET_PHENOTYPE_COLLECTION_NAME}/merged.long.disjoint.with.population.without.potential.polymorphism.with.enough.read.support.with.phenotype.sequenced.samples.only.dt.txt.gz",
        phenotype_of_samples_without_edits_before_sample_support_filter_dt_filename="result/S71_4__filter_for_variants_with_enough_sample_support_for_control/{DATASET_COLLECTION_NAME}/{DATASET_PHENOTYPE_COLLECTION_NAME}/phenotype.of.samples.without.edits.before.sample.support.filter.dt.txt",
        merged_long_disjoint_with_population_without_potential_polymorphism_with_enough_read_support_with_phenotype_sequenced_samples_only_with_enough_sample_support_dt_txt_gz_filename="result/S71_4__filter_for_variants_with_enough_sample_support_for_control/{DATASET_COLLECTION_NAME}/{DATASET_PHENOTYPE_COLLECTION_NAME}/merged.long.disjoint.with.population.without.potential.polymorphism.with.enough.read.support.with.phenotype.sequenced.samples.only.with.enough.sample.support.dt.txt.gz"
    threads:
        config['threads_filter_for_variants_with_enough_sample_support']
    script:
        "./scripts/S71_4__filter_for_variants_with_enough_sample_support_for_control/run.R"

rule S71_5__filter_for_A_to_G_sites_for_control:
    input:
        flag_S71_4="result/S71_4__filter_for_variants_with_enough_sample_support_for_control/{DATASET_COLLECTION_NAME}/{DATASET_PHENOTYPE_COLLECTION_NAME}/finished",
        merged_long_disjoint_with_population_without_potential_polymorphism_with_enough_read_support_with_phenotype_sequenced_samples_only_with_enough_sample_support_dt_txt_gz_filename="result/S71_4__filter_for_variants_with_enough_sample_support_for_control/{DATASET_COLLECTION_NAME}/{DATASET_PHENOTYPE_COLLECTION_NAME}/merged.long.disjoint.with.population.without.potential.polymorphism.with.enough.read.support.with.phenotype.sequenced.samples.only.with.enough.sample.support.dt.txt.gz",
        combined_merged_variant_only_snpEff_event_summary_dt_gz_filename="result/S18_1__combine_annotations/{DATASET_COLLECTION_NAME}/__merged__/DNTRSeq-RNA-trimming/hg38.fa/32/bwa-index-10.1038_nmeth.2330/bwa-aln-samsepe/none/GATK-3.6.0/none/151/common_all/complex_filter_1/none/snpEff/basic/10000000/combined.merged.variant.only.snpEff.event.summary.dt.txt.gz"
    output:
        flag_S71_5=touch("result/S71_5__filter_for_A_to_G_sites_for_control/{DATASET_COLLECTION_NAME}/{DATASET_PHENOTYPE_COLLECTION_NAME}/finished"),
    ...
    script:
        "./scripts/S71_5__filter_for_A_to_G_sites_for_control/run.R"


rule S71_6__get_snpEff_annotation_subset_of_filtered_result_for_control:
    input:
    ...
    output:
        flag_S71_6=touch("result/S71_6__get_snpEff_annotation_subset_of_filtered_result_for_control/{DATASET_COLLECTION_NAME}/{DATASET_PHENOTYPE_COLLECTION_NAME}/finished"),
        merged_long_disjoint_with_population_without_potential_polymorphism_with_enough_read_support_with_phenotype_sequenced_samples_only_with_enough_sample_support_A_to_G_only_with_snpEff_annotation_dt_txt_gz_filename="result/S71_6__get_snpEff_annotation_subset_of_filtered_result_for_control/{DATASET_COLLECTION_NAME}/{DATASET_PHENOTYPE_COLLECTION_NAME}/merged.long.disjoint.with.population.without.potential.polymorphism.with.enough.read.support.with.phenotype.sequenced.samples.only.with.enough.sample.support.A.to.G.only.with.snpEff.annotation.dt.txt.gz",
    ...
    script:
        "./scripts/S71_6__get_snpEff_annotation_subset_of_filtered_result_for_control/run.R"




rule S72_1__check_variant_converage_of_merged_bam_for_control:
    input:
        flag_S71_5="result/S71_5__filter_for_A_to_G_sites_for_control/{DATASET_COLLECTION_NAME}/{DATASET_PHENOTYPE_COLLECTION_NAME}/finished",
        merged_long_disjoint_with_population_without_potential_polymorphism_with_enough_read_support_with_phenotype_sequenced_samples_only_with_enough_sample_support_A_to_G_only_dt_bed_filename="result/S71_5__filter_for_A_to_G_sites_for_control/{DATASET_COLLECTION_NAME}/{DATASET_PHENOTYPE_COLLECTION_NAME}/merged.long.disjoint.with.population.without.potential.polymorphism.with.enough.read.support.with.phenotype.sequenced.samples.only.with.enough.sample.support.A.to.G.only.bed",
        alignment_sorted_withRG_dedup_converted_bq_sorted_without_splicing_junction_SN_bam_filename="result/S15_1__get_sample_RNA_editing_sites_v3/{TYPE}/{DATASET}/{SAMPLE}/__merged__/DNTRSeq-RNA-trimming/hg38.fa/32/bwa-index-10.1038_nmeth.2330/{INDEXER_PARAMETERS}/bwa-aln-samsepe/none/GATK-3.6.0/none/151/common_all/alignment.sorted.withRG.dedup.converted.bq.sorted.without.splicing.junction.SN.bam"
    output:
        flag_S72_1=touch("result/S72_1__check_variant_converage_of_merged_bam_for_control/{DATASET_COLLECTION_NAME}/{DATASET_PHENOTYPE_COLLECTION_NAME}/{TYPE}/{DATASET}/{SAMPLE}/{INDEXER_PARAMETERS}/finished"),
        alignment_merged_depth_on_merged_variant_only_bed_txt_gz_filename="result/S72_1__check_variant_converage_of_merged_bam_for_control/{DATASET_COLLECTION_NAME}/{DATASET_PHENOTYPE_COLLECTION_NAME}/{TYPE}/{DATASET}/{SAMPLE}/{INDEXER_PARAMETERS}/alignment.merged.depth.on.merged.variant.only.bed.txt.gz"
    threads:
        1
    shell:
        """
...
rule B72_1__check_variant_converage_of_merged_bam_for_control:
    input:
        lambda wildcards: ["result/S72_1__check_variant_converage_of_merged_bam_for_control/{DATASET_COLLECTION_NAME}/{DATASET_PHENOTYPE_COLLECTION_NAME}/" + temp_row.TYPE + "/" + temp_row.DATASET_NAME + '/' + temp_row.SAMPLE_NAME  + "/" + str(temp_row.INDEXER_PARAMETERS) +  "/finished" for temp_row in __get_parameters_collection_for_RNA_editing_calling(wildcards.DATASET_COLLECTION_NAME)]
    output:
        flag_B72_1=touch("result/B72_1__check_variant_converage_of_merged_bam_for_control/{DATASET_COLLECTION_NAME}/{DATASET_PHENOTYPE_COLLECTION_NAME}/finished")




## must take unique at the depth filename list step to avoid duplicated records
def __S72_2_write_alignment_merged_depth_on_merged_variant_only_bed_txt_gz_filename_collection_to_file_and_return_filename(wildcards):
    temp_result_directory = "result/S72_2__concatenate_all_variant_coverages_of_merged_bam_for_control/" + wildcards.DATASET_COLLECTION_NAME + "/"  + wildcards.DATASET_PHENOTYPE_COLLECTION_NAME  + "/"
    temp_dataset_and_sample_and_depth_filename_list_filename = temp_result_directory + "/temp_dataset_and_sample_and_depth_filename_list.txt"
    os.makedirs(temp_result_directory, exist_ok=True)
    temp_dataset_and_sample_and_depth_filenames_collection = set([temp_row.DATASET_NAME + "," + temp_row.SAMPLE_NAME + "," + "result/S72_1__check_variant_converage_of_merged_bam_for_control/" + wildcards.DATASET_COLLECTION_NAME + "/"  + wildcards.DATASET_PHENOTYPE_COLLECTION_NAME  + "/" + temp_row.TYPE + "/" + temp_row.DATASET_NAME + "/" + temp_row.SAMPLE_NAME + "/" + str(temp_row.INDEXER_PARAMETERS) +  "/alignment.merged.depth.on.merged.variant.only.bed.txt.gz" for temp_row in __get_parameters_collection_for_RNA_editing_calling(wildcards.DATASET_COLLECTION_NAME)]) ## take unique datasets
    with open(temp_dataset_and_sample_and_depth_filename_list_filename, "w") as temp_self_filehandle:
        print("writing...")
        temp_self_filehandle.writelines([temp_dataset_and_sample_and_depth_filename + "\n" for temp_dataset_and_sample_and_depth_filename in temp_dataset_and_sample_and_depth_filenames_collection])
    return temp_dataset_and_sample_and_depth_filename_list_filename
...
rule S72_2__concatenate_all_variant_coverages_of_merged_bam_for_control:
    input:
        flag_B72_1="result/B72_1__check_variant_converage_of_merged_bam_for_control/{DATASET_COLLECTION_NAME}/{DATASET_PHENOTYPE_COLLECTION_NAME}/finished"
    output:
        flag_S72_2=touch("result/S72_2__concatenate_all_variant_coverages_of_merged_bam_for_control/{DATASET_COLLECTION_NAME}/{DATASET_PHENOTYPE_COLLECTION_NAME}/finished"),
        combined_all_single_bam_coverages_of_the_bed_generated_from_vcf_txt_gz_filename="result/S72_2__concatenate_all_variant_coverages_of_merged_bam_for_control/{DATASET_COLLECTION_NAME}/{DATASET_PHENOTYPE_COLLECTION_NAME}/combined.all.single.bam.coverages.of.the.bed.generated.from.vcf.txt.gz"
    params:
        alignment_merged_depth_on_merged_variant_only_bed_txt_gz_filename_collection_filename=lambda wildcards: __S72_2_write_alignment_merged_depth_on_merged_variant_only_bed_txt_gz_filename_collection_to_file_and_return_filename(wildcards),
        temp_combined_all_single_bam_coverages_of_the_bed_generated_from_vcf_txt_filename="result/S72_2__concatenate_all_variant_coverages_of_merged_bam_for_control/{DATASET_COLLECTION_NAME}/{DATASET_PHENOTYPE_COLLECTION_NAME}/combined.all.single.bam.coverages.of.the.bed.generated.from.vcf.txt"
    threads:
...
rule S72_2__concatenate_all_variant_coverages_of_merged_bam_for_control____patch01__extract_zero_depth_records:
    input:
        flag_S72_2="result/S72_2__concatenate_all_variant_coverages_of_merged_bam_for_control/{DATASET_COLLECTION_NAME}/{DATASET_PHENOTYPE_COLLECTION_NAME}/finished",
        combined_all_single_bam_coverages_of_the_bed_generated_from_vcf_txt_gz_filename="result/S72_2__concatenate_all_variant_coverages_of_merged_bam_for_control/{DATASET_COLLECTION_NAME}/{DATASET_PHENOTYPE_COLLECTION_NAME}/combined.all.single.bam.coverages.of.the.bed.generated.from.vcf.txt.gz"
    output:
        flag_S72_2_patch01=touch("result/S72_2__concatenate_all_variant_coverages_of_merged_bam_for_control/{DATASET_COLLECTION_NAME}/{DATASET_PHENOTYPE_COLLECTION_NAME}/finished.patch01__extract_zero_depth_records"),
        combined_all_single_bam_coverages_of_the_bed_generated_from_vcf_txt_zero_depth_records_only_gz_filename="result/S72_2__concatenate_all_variant_coverages_of_merged_bam_for_control/{DATASET_COLLECTION_NAME}/{DATASET_PHENOTYPE_COLLECTION_NAME}/combined.all.single.bam.coverages.of.the.bed.generated.from.vcf.zero.depth.records.only.txt.gz"
    threads:
        config['threads_reduce_and_pigz_compress_tables']
    shell:
        """
...
rule S72_2__concatenate_all_variant_coverages_of_merged_bam_for_control____patch02__extract_nonzero_depth_records:
    input:
        flag_S72_2="result/S72_2__concatenate_all_variant_coverages_of_merged_bam_for_control/{DATASET_COLLECTION_NAME}/{DATASET_PHENOTYPE_COLLECTION_NAME}/finished",
        combined_all_single_bam_coverages_of_the_bed_generated_from_vcf_txt_gz_filename="result/S72_2__concatenate_all_variant_coverages_of_merged_bam_for_control/{DATASET_COLLECTION_NAME}/{DATASET_PHENOTYPE_COLLECTION_NAME}/combined.all.single.bam.coverages.of.the.bed.generated.from.vcf.txt.gz"
    output:
        flag_S72_2_patch02=touch("result/S72_2__concatenate_all_variant_coverages_of_merged_bam_for_control/{DATASET_COLLECTION_NAME}/{DATASET_PHENOTYPE_COLLECTION_NAME}/finished.patch02__extract_nonzero_depth_records"),
        combined_all_single_bam_coverages_of_the_bed_generated_from_vcf_txt_nonzero_depth_records_only_gz_filename="result/S72_2__concatenate_all_variant_coverages_of_merged_bam_for_control/{DATASET_COLLECTION_NAME}/{DATASET_PHENOTYPE_COLLECTION_NAME}/combined.all.single.bam.coverages.of.the.bed.generated.from.vcf.nonzero.depth.records.only.txt.gz"
    threads:
        config['threads_reduce_and_pigz_compress_tables']
    shell:
        """
...
rule S72_3__mark_unsequenced_editing_sites_for_control:
    input:
        flag_S71_5="result/S71_5__filter_for_A_to_G_sites_for_control/{DATASET_COLLECTION_NAME}/{DATASET_PHENOTYPE_COLLECTION_NAME}/finished",
        merged_long_disjoint_with_population_without_potential_polymorphism_with_enough_read_support_with_phenotype_sequenced_samples_only_with_enough_sample_support_A_to_G_only_dt_txt_gz_filename="result/S71_5__filter_for_A_to_G_sites_for_control/{DATASET_COLLECTION_NAME}/{DATASET_PHENOTYPE_COLLECTION_NAME}/merged.long.disjoint.with.population.without.potential.polymorphism.with.enough.read.support.with.phenotype.sequenced.samples.only.with.enough.sample.support.A.to.G.only.dt.txt.gz",
        flag_S72_2_patch01="result/S72_2__concatenate_all_variant_coverages_of_merged_bam_for_control/{DATASET_COLLECTION_NAME}/{DATASET_PHENOTYPE_COLLECTION_NAME}/finished.patch01__extract_zero_depth_records",
        combined_all_single_bam_coverages_of_the_bed_generated_from_vcf_zero_depth_records_only_txt_gz_filename="result/S72_2__concatenate_all_variant_coverages_of_merged_bam_for_control/{DATASET_COLLECTION_NAME}/{DATASET_PHENOTYPE_COLLECTION_NAME}/combined.all.single.bam.coverages.of.the.bed.generated.from.vcf.zero.depth.records.only.txt.gz",
        flag_S72_2_patch02="result/S72_2__concatenate_all_variant_coverages_of_merged_bam_for_control/{DATASET_COLLECTION_NAME}/{DATASET_PHENOTYPE_COLLECTION_NAME}/finished.patch02__extract_nonzero_depth_records",
    ...
    output:
        flag_S72_3=touch("result/S72_3__mark_unsequenced_editing_sites_for_control/{DATASET_COLLECTION_NAME}/{DATASET_PHENOTYPE_COLLECTION_NAME}/finished"),
        test_merge_result_dt_txt_filename="result/S72_3__mark_unsequenced_editing_sites_for_control/{DATASET_COLLECTION_NAME}/{DATASET_PHENOTYPE_COLLECTION_NAME}/test.merge.result.dt.txt",
        merged_long_disjoint_with_population_without_potential_polymorphism_with_enough_read_support_with_phenotype_sequenced_samples_only_with_enough_sample_support_A_to_G_only_merged_with_coverage_dt_txt_gz_filename="result/S72_3__mark_unsequenced_editing_sites_for_control/{DATASET_COLLECTION_NAME}/{DATASET_PHENOTYPE_COLLECTION_NAME}/merged.long.disjoint.with.population.without.potential.polymorphism.with.enough.read.support.with.phenotype.sequenced.samples.only.with.enough.sample.support.A.to.G.only.merged.with.coverage.dt.txt.gz"
    threads:
        config['threads_mark_unsequenced_editing_sites']
    script:
        "./scripts/S72_3__mark_unsequenced_editing_sites_for_control/run.R"
